...
// ShanuTechX: shared global tokens — rounder corners across every component
// (Button, Input, Card, Modal, Popover, Dropdown, Tag, etc.) without having
// to override each one individually.
const SHARED_TOKENS = {
  borderRadius:   10,   // base radius  — inputs, tags, avatars
  borderRadiusLG: 14,   // large radius — cards, modals, drawers
  borderRadiusSM:  6,   // small radius — badges, small buttons
  borderRadiusXS:  4,   // extra-small  — tooltips, mini-chips
};
