...
const REPO_URL = 'https://github.com/ShanudhaTirosh/shanutechx-panel';
    ...
    <div className="ant-sidebar">
      ...
      >
        <div className={`sider-brand${collapsed ? ' sider-brand-collapsed' : ''}`}>
          <div className="brand-block">
            <span className="brand-text">{collapsed ? 'ShX' : 'ShanuTechX'}</span>
          </div>
          {!collapsed && (
      ...
      >
        <div className="drawer-header">
          <div className="brand-block">
            <span className="drawer-brand">ShanuTechX</span>
          </div>
